...
test("spawner resolves exec with the command stdout", async function (t) {
  ...
  assert.equal(await readFile(resultFile, "utf8"), "jarmuz-exec-output\n");
});
